...
Create a bar plot of the most frequently products ordered from which asile. This can show which aisles are top sellers or consistently reordered.
```{r}
data |> 
  count(aisle)  |> 
  filter(
...
Scatterplot of Order Size vs. Days Since Prior Order
